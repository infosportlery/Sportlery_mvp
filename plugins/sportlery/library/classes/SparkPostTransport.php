...
/**
 * SparkPostTransport class backported from Laravel 5.2+
 *
 * @link https://github.com/laravel/framework/blob/5.4/src/Illuminate/Mail/Transport/SparkPostTransport.php
 */
